...
- ```plot_effect_heatmap```: customizable heatmap of e.g. correlation coefficients and p-values
...
- ```save_group_boxplots```: boxplots of metabolite levels in each study group  
