...
Set up a log file in the path directory manually. Many functions of the package will log information when they have finished. This helps monitoring the analysis process in case something goes wrong AND to review the results later.
